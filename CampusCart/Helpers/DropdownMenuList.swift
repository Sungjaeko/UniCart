...
struct DropdownMenuList: View {
    ...
    var body: some View {
        ...
        // Check first if number of options * 32 (Option height - CONSTANT
        // YOU MAY CHANGE IT) is greater than 300 (MAX HEIGHT - ALSO, YOU MAY
        // CHANGE IT). if true, then make it options list scroll
...
struct DropdownMenuList_Previews: PreviewProvider {
    static var previews: some View {
        DropdownMenuList(options: DropdownMenuOption.testAllConditions,
